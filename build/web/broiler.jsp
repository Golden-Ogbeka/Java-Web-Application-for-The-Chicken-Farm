<%-- 
    Document   : broiler
    Created on : 04-Feb-2018, 13:59:57
    Author     : Nedlog
--%>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/broiler1.jpg" />
                                            <img class="etalage_source_image" src="images/broiler1.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/broiler2.jpg" />
                                        <img class="etalage_source_image" src="images/broiler2.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/broiler3.jpg" />
                                        <img class="etalage_source_image" src="images/broiler3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/broiler1.jpg" />
                                        <img class="etalage_source_image" src="images/broiler1.jpg" />
                        ...
                        <form action="CartController" method="post">
                            <div class="col-md-3">
                                <div class="box-info-product">
                                    <p class="price2">₦100.00</p>
                                    <input type="hidden" name="productType" value="Broiler">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 product1">
                            ...
                            <div class="shop_desc"><a href="cockerel.jsp">
                                ...
                                <p>Male bird groomed for reproduction</p>
                        ...
                        <div class="col-md-4 product1">
                            ...
                            <div class="shop_desc"><a href="layer.jsp">
                                ...
                                <p>Female bird groomed for reproduction</p>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="shop_desc"><a href="chick.jsp">
                                ...
                                <p>Little birds that are products of reproduction</p>
