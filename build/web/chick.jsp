<%-- 
    Document   : chick
    Created on : 04-Feb-2018, 14:00:08
    Author     : Nedlog
--%>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/chick1.jpg" />
                                            <img class="etalage_source_image" src="images/chick1.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick2.jpg" />
                                        <img class="etalage_source_image" src="images/chick2.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick3.jpg" />
                                        <img class="etalage_source_image" src="images/chick3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick4.jpg" />
                                        <img class="etalage_source_image" src="images/chick4.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick5.jpg" />
                                        <img class="etalage_source_image" src="images/chick5.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick6.jpg" />
                                        <img class="etalage_source_image" src="images/chick6.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/chick2.jpg" />
                                        <img class="etalage_source_image" src="images/chick2.jpg" />
                        ...
                        <form action="CartController" method="post">
                            <div class="col-md-3">
                                <div class="box-info-product">
                                    <p class="price2">₦30.00</p>
                                    <input type="hidden" name="productType" value="Chick">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 product1">
                            ...
                            <div class="shop_desc"><a href="cockerel.jsp">
                                </a><h3><a href="cockerel.jsp"></a><a href="cockerel.jsp">Cockerels</a></h3>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="shop_desc"><a href="layer.jsp">
                                </a><h3><a href="layer.jsp"></a><a href="layer.jsp">Layers</a></h3>
