<%-- 
    Document   : cockerel
    Created on : 04-Feb-2018, 14:00:34
    Author     : Nedlog
--%>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/cockerel1.jpg" />
                                            <img class="etalage_source_image" src="images/cockerel1.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/cockerel2.jpg" />
                                        <img class="etalage_source_image" src="images/cockerel2.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/cockerel3.jpg" />
                                        <img class="etalage_source_image" src="images/cockerel3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/cockerel4.jpg" />
                                        <img class="etalage_source_image" src="images/cockerel4.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/cockerel1.jpg" />
                                        <img class="etalage_source_image" src="images/cockerel1.jpg" />
                        ...
                        <form action="CartController" method="post">
                            <div class="col-md-3">
                                <div class="box-info-product">
                                    ...
                                    <input type="hidden" name="productType" value="Cockerel">
