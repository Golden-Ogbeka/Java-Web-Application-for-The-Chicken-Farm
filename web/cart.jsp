<%-- 
    Document   : cart
    Created on : 04-Feb-2018, 14:22:11
    Author     : Nedlog
--%>
        ...
        <div class="main">
            <div class="shop_top">
                <div class="container">
                    ...
                    <center>   <h1>Products in Your Cart</h1></center>
                    <table class="table">
                    ...
                    <form class="form-submit" action="CartOperations">
                        <table>
                            <tr>
                                <td>

                                    <input type="submit" value="Clear Cart" name="registerdirect"/>

                                </td>
                            </tr>
                        </table>
                    </form>
                    <form class="form-submit" action="checkout.jsp">
                        <table>
                            <tr>
                                <td>
